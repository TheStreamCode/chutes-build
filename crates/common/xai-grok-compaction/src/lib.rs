...
//! `xai-grok-sampling-types`. It is decoupled from both Chutes Build chat and
...
//! - [`intra_compaction`] — Chutes Build chat's tail-keep, per-step pass.
//! - [`inter_compaction`] — Chutes Build chat's chunked, between-turn pass.
//!
...
//! (active-agent-state `<system-reminder>` formatting shared by Chutes Build chat and
