...
/// `filename`, `path`, `metadata`) that the Chutes Build SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the Chutes Build SLOP converter to
    ...
    /// - `path`: file path on the Chutes Build Computer filesystem
