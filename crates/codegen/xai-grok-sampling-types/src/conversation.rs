...
// ---------------------------------------------------------------------------
//
// Part of the Chutes Build Compaction unification. Lets the shared, transport-agnostic
...
mod tests {
    ...
    fn test_transform_cwd_transforms_tool_call_arguments() {
        ...
        let worktree = "/home/user/.chutes-build/worktrees/project/ab-uuid-a";
    ...
    fn test_transform_cwd_worktree_to_root_syncback() {
        ...
        let worktree = "/home/user/.chutes-build/worktrees/myproject/fork-a";
    ...
    fn test_transform_cwd_assistant_only_tool_calls_no_content() {
        ...
        let worktree = "/home/user/.chutes-build/worktrees/proj/fork-a";
