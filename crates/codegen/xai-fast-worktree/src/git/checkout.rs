...
fn snapshot_worktree_to_ref_inner(
    ...
    const NAME: &str = "Chutes Build Snapshot";
...
mod tests {
    ...
    fn test_rehydrate_registers_worktree_in_db() {
        ...
        // Isolate the worktree DB (lock + CHUTES_BUILD_HOME → private tmp + restore).
        ...
        // global CHUTES_BUILD_HOME) DB and INSERT-OR-REPLACE our row.
        ...
        // other subagent rows since CHUTES_BUILD_HOME is process-global. Match the
