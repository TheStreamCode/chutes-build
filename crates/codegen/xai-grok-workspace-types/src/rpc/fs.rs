...
//! the shell's `chutes.build/fs/*` ACP methods.
...
// `workspace.fs_*` ops above already serve the shell's `chutes.build/fs/*`
...
/// Filesystem node kind. Wire values match the shell's `chutes.build/fs/list`
/// node `type` strings.
...
/// `chutes.build/fs/list` plus `offset` pagination).
