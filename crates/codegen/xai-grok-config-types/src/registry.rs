...
pub const FEATURES: &[FeatureSpec] = &[
    FeatureSpec {
        ...
        env: "CHUTES_BUILD_SESSION_SEARCH",
    ...
    FeatureSpec {
        ...
        env: "CHUTES_BUILD_SESSION_RECAP",
        default_enabled: true,
    ...
    FeatureSpec {
        ...
        env: "CHUTES_BUILD_ASK_USER_QUESTION",
        default_enabled: true,
    ...
    FeatureSpec {
        ...
        env: "CHUTES_BUILD_FEEDBACK_ENABLED",
        default_enabled: true,
    ...
    FeatureSpec {
        ...
        env: "CHUTES_BUILD_CANCEL_REWIND",
        default_enabled: true,
    ...
    FeatureSpec {
        ...
        env: "CHUTES_BUILD_COMPACTION_VERBATIM_INPUT",
        default_enabled: true,
    ...
    FeatureSpec {
        ...
        env: "CHUTES_BUILD_TWO_PASS_COMPACTION",
        default_enabled: true,
    ...
    FeatureSpec {
        ...
        env: "CHUTES_BUILD_BACKEND_SEARCH",
        default_enabled: true,
        remote: None,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        env: "CHUTES_BUILD_SUBAGENT_WORKTREE_SNAPSHOT",
        default_enabled: false,
    ...
    FeatureSpec {
        ...
        env: "CHUTES_BUILD_ACTIVE_AGENT_MESSAGES",
        default_enabled: false,
