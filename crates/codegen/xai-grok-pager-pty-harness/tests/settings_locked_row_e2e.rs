...
//! `CHUTES_BUILD_PRIVACY_NOTICE_ROLLOUT=1` — asserted on the authenticated welcome
...
/// the sandbox's fake `CHUTES_API_KEY` removed so the seeded team OAuth entry is
...
fn locked_row_env_ops() -> [EnvOp<'static>; 3] {
    [
        ...
        EnvOp::set("CHUTES_BUILD_ZDR_ACCESS_ENABLED", "1"),
