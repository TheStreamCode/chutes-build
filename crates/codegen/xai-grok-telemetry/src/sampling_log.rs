//! Tracing layer for `target: "sampling_log"` → `~/.chutes-build/logs/sampling.jsonl`.
//! Enable with `--log-sampling` or `CHUTES_BUILD_LOG_SAMPLING=1`.
...
const ENV_VAR: &str = "CHUTES_BUILD_LOG_SAMPLING";
