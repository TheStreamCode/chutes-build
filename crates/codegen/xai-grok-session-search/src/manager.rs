...
/// Manages background session indexing for every Chutes Build home this process
/// touches.
///
...
impl SearchIndexManager {
    /// Start the dispatcher. `source_factory` opens the session store for a Chutes Build home and
