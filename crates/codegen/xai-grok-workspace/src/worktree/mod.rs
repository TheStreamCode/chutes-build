...
/// Env + `$CHUTES_BUILD_HOME/config.toml` only — **`remote=None` is intentional**.
///
...
/// processes; use `CHUTES_BUILD_WORKTREE_AUTO_GC=0` / `CHUTES_BUILD_WORKTREE_AUTO_GC_DRY_RUN=1`
