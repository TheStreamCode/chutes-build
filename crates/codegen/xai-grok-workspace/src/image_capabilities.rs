...
pub const CAPABILITIES_DIR_ENV: &str = "CHUTES_BUILD_IMAGE_CAPABILITIES_DIR";
...
mod tests {
    ...
    fn invalid_names_and_non_files_are_dropped() {
        ...
        // Windows normalizes trailing-dot names to `notes.txt`, which is a
        // valid capability name there; the trailing-dot case only exists on
        // platforms whose filesystems allow the name.
        #[cfg(not(windows))]
