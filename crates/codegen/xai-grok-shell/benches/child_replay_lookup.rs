...
//! order as a fat local `~/.chutes-build/sessions`). Override with env:
//!
//! ```text
...
//! CHILD_REPLAY_LOOKUP_HOME=$HOME/.chutes-build cargo bench -p xai-grok-shell --bench child_replay_lookup
//! ```
