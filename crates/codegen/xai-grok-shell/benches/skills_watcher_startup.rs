...
//! # optional scale:
//! CHUTES_BUILD_SKILLS_WATCHER_BENCH_DIRS=12000 cargo bench -p xai-grok-shell --bench skills_watcher_startup
//! ```
//!
...
fn worktree_dir_count() -> usize {
    std::env::var("CHUTES_BUILD_SKILLS_WATCHER_BENCH_DIRS")
        .ok()
