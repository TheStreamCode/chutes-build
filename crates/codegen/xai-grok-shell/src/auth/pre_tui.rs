...
//!
//! `auth_provider_command` already works via `chutes-build login` because stderr is
...
//! URLs). This module is the first-launch equivalent of `chutes-build login`: print the
