...
pub async fn handle(
    ...
    match args.method.as_ref() {
        ...
        // Queries
        // ───────────────────────────────────────────────────────────────
        "chutes.build/hunk-tracker/get-hunks" => {
        ...
        "chutes.build/hunk-tracker/get-files" => {
        ...
        "chutes.build/hunk-tracker/get-all-file-contents" => {
            let req = parse_params::<GetFilesRequest>(args)?;
        ...
        "chutes.build/hunk-tracker/get-summary" => {
        ...
        // Single Hunk Action
        // ───────────────────────────────────────────────────────────────
        "chutes.build/hunk-tracker/hunk-action" => {
        ...
        // Bulk Actions
        // ───────────────────────────────────────────────────────────────
        "chutes.build/hunk-tracker/file-action" => {
        ...
        "chutes.build/hunk-tracker/turn-action" => {
        ...
        "chutes.build/hunk-tracker/all-action" => {
