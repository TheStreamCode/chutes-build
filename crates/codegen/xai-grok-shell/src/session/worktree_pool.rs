...
//!   under `~/.chutes-build/worktree_pool/<instance_id>/` with a `.pid` liveness
...
/// `~/.chutes-build/worktree_pool/<instance_id>/` with a `.pid` file recording
...
impl WorktreePool {
    ...
    /// `~/.chutes-build/worktree_pool/<instance_id>/`. A `.pid` file is written so
...
pub struct AdoptableWorktree {
    /// Current path: `~/.chutes-build/worktree_pool/<old_instance>/<pool_id>/`
...
/// `~/.chutes-build/worktree_pool/`, reads each `.pid` file, and checks
...
/// The base pool directory under `~/.chutes-build/`.
...
/// `CleanAll` mode. Placed under `~/.chutes-build/worktree_pool/<instance_id>/<uuid>/`.
