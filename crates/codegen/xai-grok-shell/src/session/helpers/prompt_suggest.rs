...
/// `CHUTES_BUILD_PROMPT_SUGGESTIONS_MODEL` keeps working for models the catalog does
...
mod tests {
    ...
    fn effective_model_env_pin_bypasses_catalog_guard() {
        // CHUTES_BUILD_PROMPT_SUGGESTIONS_MODEL is the explicit escape hatch: used
