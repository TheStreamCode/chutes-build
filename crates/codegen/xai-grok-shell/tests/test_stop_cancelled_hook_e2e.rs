...
//!
//! `#[ignore]`d by default: it needs the grok binary (`CHUTES_BUILD_BINARY` or a local debug build).
//! `cargo test -p xai-grok-shell --test test_stop_cancelled_hook_e2e -- --ignored`
