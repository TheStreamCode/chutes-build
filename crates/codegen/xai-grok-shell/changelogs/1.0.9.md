...
- **chutes-build mcp add** now correctly treats bare http(s):// URLs as HTTP servers instead of stdio commands.
...
- **Interactive chutes-build sessions** now start in ask mode by default again instead of auto.
