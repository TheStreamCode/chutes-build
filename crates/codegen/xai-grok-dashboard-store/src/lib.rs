...
/// The canonical store path under a Chutes Build home.
/// The caller resolves the Chutes Build home (nothing in this crate reads `CHUTES_BUILD_HOME`); tests pass a temp dir.
