...
/// tool falls back to `Cwd/.chutes-build/plan.md`.
#[derive(Debug, Clone)]
...
pub const PLAN_FILE_RELATIVE_PATH: &str = ".chutes-build/plan.md";
...
/// [`Cwd`]`/.chutes-build/plan.md`, else the bare relative `.chutes-build/plan.md`.
