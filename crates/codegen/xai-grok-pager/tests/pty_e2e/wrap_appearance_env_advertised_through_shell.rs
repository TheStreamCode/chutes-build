...
const PRINT_APPEARANCE: &str =
    "printf 'grok=%s lc=%s\\n' \"$CHUTES_BUILD_APPEARANCE\" \"$LC_CHUTES_BUILD_APPEARANCE\"";
...
///
/// The parent pins CHUTES_BUILD_APPEARANCE and LC_CHUTES_BUILD_APPEARANCE empty.
...
/// The parent sets `CHUTES_BUILD_APPEARANCE=light` and pins LC empty.
