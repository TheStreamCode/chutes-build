...
/// The robust "new session" signal is then a *second* welcome card (two `Chutes Build` banners across scrollback and screen).
...
async fn minimal_new_session_keeps_history_and_resets() {
    ...
    const WELCOME_BANNER: &str = "Chutes Build";
