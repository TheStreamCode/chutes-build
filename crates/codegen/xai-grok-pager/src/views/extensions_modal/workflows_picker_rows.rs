...
pub(super) const WORKFLOWS_EMPTY_PLACEHOLDER: &str =
    "No workflows available. Ask Chutes Build to help make you one!";
    ...
    fn filters_on_name_and_description() {
        let workflows = TabDataState::Loaded(vec![
            WorkflowInfo {
                ...
                when_to_use: None,
                source: "user".into(),
                path: Some("/home/u/.chutes-build/workflows/alpha-wf.rhai".into()),
            },
            WorkflowInfo {
                name: "beta-wf".into(),
        ...
        assert_eq!(
            ...
            [(
                "path".to_string(),
                "/home/u/.chutes-build/workflows/alpha-wf.rhai".to_string()
            )]
        );
