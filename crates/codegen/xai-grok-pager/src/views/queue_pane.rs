...
pub enum QueueRowOrigin {
    ...
    /// while running). Edits route to the agent as `chutes.build/queue/*`.
    Server,
}
...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. ChutesNight's dark band leaking into ChutesDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default ChutesNight, dark) after the user switches —
        // painting a dark band on a light ChutesDay canvas.
