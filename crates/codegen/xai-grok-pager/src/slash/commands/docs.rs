...
/// The online Build docs landing page, hardcoded like other TUI deep-links; docs.chutes.ai can redirect if the path moves.
pub const BUILD_DOCS_URL: &str = "https://docs.chutes.ai/build/overview";
