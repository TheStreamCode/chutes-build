...
//! `chutes.build/bundle/status`. The shell now performs the actual bundle download in
...
///
/// Populated from `chutes.build/bundle/status` ACP responses.
...
/// Deserialized response from `chutes.build/bundle/status`.
...
/// Deserialized response from `chutes.build/bundle/entry/get`.
#[derive(Debug, Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
