...
//! `chutes.ai/bundle/status`. The shell now performs the actual bundle download in
...
///
/// Populated from `chutes.ai/bundle/status` ACP responses.
...
/// Deserialized response from `chutes.ai/bundle/status`.
...
/// Deserialized response from `chutes.ai/bundle/entry/get`.
#[derive(Debug, Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
