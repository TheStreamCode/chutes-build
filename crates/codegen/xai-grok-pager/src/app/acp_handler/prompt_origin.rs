...
/// `chutes.build/session/prompt_complete` turn-end signal. A viewer can thus safely
...
/// adoptable iff the turn emits a terminal `chutes.build/session/prompt_complete`, the
