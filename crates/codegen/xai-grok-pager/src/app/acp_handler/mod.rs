...
fn handle_ext_notification(notif: &acp::ExtNotification, app: &mut AppView) -> bool {
    ...
    match method {
        "chutes.ai/follow_ups" => handle_follow_ups(notif, app),
        "chutes.ai/task_backgrounded" => handle_task_backgrounded(notif, app),
        "chutes.ai/task_completed" => handle_task_completed(notif, app),
        "chutes.ai/models/update" => handle_models_update(notif, app),
        "chutes.ai/settings/update" => handle_settings_update(notif, app),
        "chutes.ai/sessions/changed" => handle_sessions_changed(notif, app),
        "chutes.ai/queue/changed" => handle_queue_changed(notif, app),
        "chutes.ai/session/prompt_complete" => handle_prompt_complete(notif, app),
        "chutes.ai/session/interjection" => handle_interjection(notif, app),
        "chutes.ai/monitor_event" => handle_monitor_event(notif, app),
        "chutes.ai/scheduled_task_created" => handle_scheduled_task_created(notif, app),
        "chutes.ai/scheduled_task_fired" => handle_scheduled_task_fired(notif, app),
        "chutes.ai/scheduled_task_deleted" => handle_scheduled_task_deleted(notif, app),
        "chutes.ai/scheduled_task_inject_prompt" => handle_scheduled_task_inject_prompt(notif, app),
        "chutes.ai/announcements/update" => handle_announcements_update(notif, app),
        "chutes.ai/git_head_changed" => handle_git_head_changed(notif, app),
        "chutes.ai/leader/version_mismatch" => handle_version_mismatch(notif, app),
        "chutes.ai/mcp/init_progress" => handle_mcp_init_progress(notif, app),
        "chutes.ai/mcp/tools_changed" | "chutes.ai/mcp_initialized" => {
            handle_mcp_tools_changed(notif, app)
        }
        "chutes.ai/mcp/server_status" if push_server_status_enabled() => {
            handle_mcp_server_status(notif, app)
        }
        "chutes.ai/mcp/elicit_complete" => handle_mcp_elicit_complete(notif, app),
        "chutes.ai/mcp/servers_updated" => handle_mcp_servers_updated(notif, app),
        _ => false,
    }
}
...
fn handle_ext_method(ext: xai_acp_lib::AcpArgs<acp::ExtRequest>, app: &mut AppView) -> bool {
    match ext.request.method.as_ref() {
        "chutes.ai/ask_user_question" => handle_ask_user_question(ext, app),
        "chutes.ai/exit_plan_mode" => handle_exit_plan_mode(ext, app),
        "chutes.ai/mcp/elicit" => handle_mcp_elicit(ext, app),
        unknown => {
