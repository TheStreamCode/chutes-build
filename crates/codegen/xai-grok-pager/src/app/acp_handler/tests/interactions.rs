#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn ask_user_question_routes_to_background_session_not_active_view() {
        ...
        let msg = AcpClientMessage::ExtMethod(xai_acp_lib::AcpArgs {
            request: acp::ExtRequest::new("chutes.ai/ask_user_question", raw.into()),
            response_tx: tx,
        });
    ...
    fn mcp_elicit_opens_elicitation_view_and_parks_response() {
        ...
        .unwrap();
        let msg = AcpClientMessage::ExtMethod(xai_acp_lib::AcpArgs {
            request: acp::ExtRequest::new("chutes.ai/mcp/elicit", raw.into()),
            response_tx: tx,
        });
    ...
    fn mcp_elicit_does_not_replace_url_waiting() {
        ...
        handle(
            AcpClientMessage::ExtMethod(xai_acp_lib::AcpArgs {
                request: acp::ExtRequest::new("chutes.ai/mcp/elicit", raw1.into()),
                response_tx: tx1,
            }),
            &mut app,
        );
        ...
        handle(
            AcpClientMessage::ExtMethod(xai_acp_lib::AcpArgs {
                request: acp::ExtRequest::new("chutes.ai/mcp/elicit", raw2.into()),
                response_tx: tx2,
            }),
            &mut app,
        );
    ...
    fn close_viewer_preserves_plan_approval_state() {
        ...
        handle(
            AcpClientMessage::ExtMethod(xai_acp_lib::AcpArgs {
                request: acp::ExtRequest::new("chutes.ai/exit_plan_mode", raw.into()),
                response_tx: tx,
            }),
            &mut app,
        );
    ...
    fn notify_status(app: &mut crate::app::app_view::AppView, cwd: &str) -> bool {
        ...
        let ext = acp::ExtNotification::new("chutes.ai/session_notification", std::sync::Arc::from(raw));
