#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    /// and the shell emits the queue-emptying `chutes.build/queue/changed` right after
    ...
    /// `chutes.build/task_backgrounded` arriving after the skipped zero-work wait
    /// re-evaluates and restores the park.
    #[test]
    ...
    fn interjection_notification_pushes_block_to_matching_session() {
        ...
        // the shell as chutes.build/session/interjection; EVERY attached pane (incl.
