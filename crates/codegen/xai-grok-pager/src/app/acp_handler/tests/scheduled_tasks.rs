#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn inject_prompt_drives_even_when_attached_as_viewer() {
        // The leader routes `chutes.ai/scheduled_task_inject_prompt` to the SINGLE session driver, so any client that receives it IS the driver
    ...
    fn inject_prompt_malformed_json_returns_false() {
        ...
        let notif = acp::ExtNotification::new("chutes.ai/scheduled_task_inject_prompt", raw.into());
