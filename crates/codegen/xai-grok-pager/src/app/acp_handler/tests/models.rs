#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    /// Regression: a machine-wide `chutes.ai/models/update` broadcast carries each model's static catalog-default effort (`high`).
    ...
    /// The prompt header and status bar then show the right effort without waiting for a later `chutes.ai/models/update`.
    #[test]
