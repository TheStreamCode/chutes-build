#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    /// Build an `chutes.ai/settings/update` carrying only the scheduler flag.
    ...
    /// The settings path must not touch announcements: the shell already emits generation-ordered `chutes.ai/announcements/update` for every settings writer.
