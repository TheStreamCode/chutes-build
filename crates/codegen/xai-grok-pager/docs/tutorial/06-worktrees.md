...
Want Chutes Build working on a feature while you (or another Chutes Build session) work on
...
- **From the shell:**
  ...
  ```bash
  chutes-build --worktree=my-feature "refactor the auth module"
  ```
...
- Run two or three Chutes Build sessions on the same repo simultaneously.
