...
Chutes Build knows its own capabilities and can configure itself. Try:
...
## Teach Chutes Build your project: AGENTS.md

Drop an `AGENTS.md` file in your repo root with build commands, conventions,
and gotchas. Chutes Build reads it automatically in every session — it's the single
...
## Teach Chutes Build your facts: memory
