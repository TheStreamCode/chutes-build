...
Fear not — your settings, rules, and skills come with you. Chutes Build
...
Run **`chutes-build inspect`** in a repo to see every rules file, skill, and MCP
server Chutes Build picked up, tagged with where it came from. Each compat source
