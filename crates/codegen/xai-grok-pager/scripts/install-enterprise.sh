#!/bin/bash
#
# Chutes Build CLI installer (enterprise channel) — https://x.ai/cli/enterprise-install.sh
#
...
# Env: CHUTES_BUILD_BIN_DIR, CHUTES_BUILD_PROXY_URL
#
# Usage:
...
#   CHUTES_BUILD_DEPLOYMENT_KEY=<key> bash <(curl -fsSL https://x.ai/cli/enterprise-install.sh)
#
