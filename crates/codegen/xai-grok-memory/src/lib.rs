//! Cross-session memory for Chutes Build.
//!
//! Memory files are markdown under `~/.chutes-build/memory/`, one global file plus a subdirectory per workspace.
//!
//! ## Data Layout
//!
//! ```text
...
//! ## Feature Flag
//!
//! Memory is enabled through `CHUTES_BUILD_MEMORY`, `[memory] enabled`, or remote settings.
