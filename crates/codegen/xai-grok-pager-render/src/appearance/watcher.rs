...
//!
//! In dev mode, watches ~/.chutes-build/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.chutes-build/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.chutes-build/pager.toml, watches for changes
