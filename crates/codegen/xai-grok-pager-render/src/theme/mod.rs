...
//! The default theme is ChutesNight (neutral gray base with TokyoNight accents).
//!
//! ## Color support
//!
...
impl ThemeKind {
    ...
    pub fn from_name(name: &str) -> Option<Self> {
        ...
        match lower.as_str() {
            ...
            "chutesnight" | "grok-night" | "dark" => Some(Self::ChutesNight),
            "tokyonight" | "tokyo-night" | "tokyo" => Some(Self::TokyoNight),
            "chutesday" | "grok-day" | "light" | "day" => Some(Self::ChutesDay),
...
impl Theme {
    ...
    fn ansi16_chrome_overrides(self, dark: bool) -> Self {
        ...
        Self {
            ...
            // Markdown content: naive Basic quantize lands ChutesNight
...
mod tests {
    ...
    fn from_str_matches_from_name_for_all_canonicals() {
        ...
        let cases = [
            ...
            ("grok-night", ThemeKind::ChutesNight),
