//! ChutesNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// ChutesNight palette — neutral gray base + TokyoNight accent colors.
//
...
impl Theme {
    /// ChutesNight theme — neutral gray base with TokyoNight accents.
    ///
