...
/// Relative file path (`images/1.png`, `.chutes-build/x.txt`) — one or more `/`-joined
...
/// media lives at `~/.chutes-build/sessions/%2F…/images/1.jpg`, which wraps in
...
mod tests {
    ...
    fn local_link_ignores_web_anchor_and_unknown() {
        ...
        assert!(local_link_to_file_target("https://chutes.ai", &media, None).is_none());
    ...
    fn scan_content_x_offset_applied() {
        let line = make_line("https://chutes.ai");
        let mut overlay = LinkOverlay::new();
    ...
    fn scan_detects_grok_session_media_path() {
        ...
        assert_eq!(
            ...
            "file:///Users/alice/.chutes-build/sessions/%252Fabc/00000000/images/1.jpg",
        );
    }
    ...
    fn scan_detects_media_path_soft_wrapped_across_rows() {
        ...
        let row0 = make_line(
            "Image generated and saved to /Users/alice/.chutes-build/sessions/%2FUsers%2Fali",
        );
        ...
        let expected_url = "file:///Users/alice/.chutes-build/sessions/%252FUsers%252Fali\
    ...
    fn scan_wrapped_path_trailing_sentence_period_excluded() {
        ...
        let row0 = make_line("Saved to /Users/me/.chutes-build/sessions/%2Fabc/019f3a86/ima");
        ...
        for link in overlay.links() {
            assert_eq!(
                &*resolve_link_target(&link.target)
                    .and_then(|resolved| resolved.osc8_url)
                    .expect("url"),
                "file:///Users/me/.chutes-build/sessions/%252Fabc/019f3a86/images/1.jpg"
            );
        }
